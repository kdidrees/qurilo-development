      ...
      <div className="relative z-10">
        <div className="px-6  sm:px-8 lg:mx-10 max-w-7xl">
          <div className="w-full lg:w-2/3 xl:w-1/2">
            ...
            <p className="md:mt-28 mt-6 font-sans font-semibold  md:text-6xl  text-white  leading-[2] md:text-left text-center">
              <span className="md:mt-8">We develop  <span className="text-pink-400">amazing</span></span>
              <br />
